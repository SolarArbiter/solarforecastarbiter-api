...
ALTER TABLE arbiter_data.forecasts CHANGE COLUMN interval_label interval_label ENUM('beginning', 'ending', 'instant') NOT NULL;
ALTER TABLE arbiter_data.observations CHANGE COLUMN interval_label interval_label ENUM('beginning', 'ending', 'instant') NOT NULL;
ALTER TABLE arbiter_data.cdf_forecasts_groups CHANGE COLUMN interval_label interval_label ENUM('beginning', 'ending', 'instant') NOT NULL;
ALTER TABLE arbiter_data.aggregates CHANGE COLUMN interval_label interval_label ENUM('beginning', 'ending', 'instant') NOT NULL;
