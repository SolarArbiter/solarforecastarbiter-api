...
BEGIN
    ...
    DECLARE same_user_org BOOLEAN DEFAULT FALSE;
    DECLARE same_role_org BOOLEAN DEFAULT FALSE;
 ...
 */
CREATE DEFINER = 'insert_rbac'@'localhost' PROCEDURE get_current_user_info (
