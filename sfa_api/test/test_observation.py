...
def test_get_observation_links(api):
    r = api.get('/observations/123e4567-e89b-12d3-a456-426655440000',
                base_url='https://localhost')
    response = r.get_json()
...
def test_get_observation_metadata(api):
...
@pytest.mark.parametrize('uuid', [
    ('7365da38-2ee5-46ed-bd48-c84c4cc5a6c8')
])
...
def test_post_observation_values_invalid_json(api, payload):
    uuid = '7365da38-2ee5-46ed-bd48-c84c4cc5a6c8'
    r = api.post(f'/observations/{uuid}/values',
                 base_url='https://localhost',
                 json=payload)
...
def test_post_observation_values_invalid_csv(api, payload):
    uuid = '7365da38-2ee5-46ed-bd48-c84c4cc5a6c8'
    r = api.post(f'/observations/{uuid}/values',
                 base_url='https://localhost',
...
def test_post_observation_values_valid_csv(api):
    uuid = '7365da38-2ee5-46ed-bd48-c84c4cc5a6c8'
    r = api.post(f'/observations/{uuid}/values',
                 base_url='https://localhost',
                 headers={'Content-Type': 'text/csv'},
...
def test_get_observation_values(api, start, end, code):
    uuid = '7365da38-2ee5-46ed-bd48-c84c4cc5a6c8'
